...
for i in $(find ./ -type f -name "*.xhtml")
do

    sed -i -E 's/<section class="chapter parent" id=".+" title=.+ class="title-val.+>/<section class="chapter parent">/g' $i
    sed -i -E 's/<section class="sect1.*" title=.+>/<section class="sect1" title="">/g' $i
    sed -i -E 's/<section class="sect2.*" title=.+>/<section class="sect2" title="">/g' $i
    sed -i -E 's/<section class="sect3.*" title=.+>/<section class="sect3" title="">/g' $i
    sed -i -E 's/<section class="sect4.*" title=.+>/<section class="sect4" title="">/g' $i
    sed -i -E 's/<section class="sect5.*" title=.+>/<section class="sect5" title="">/g' $i
